...
class Server : public Application
{
  public:
    ...
    class ClientSessionData
    {
      public:
        ...
        ns3::Time
            m_timeEndReceivingModelFromClient; //!< Set time when last message received by server
     ...
     */
    std::map<Ptr<Socket>, std::shared_ptr<ClientSessionData>> GetAcceptedSockets() const;

    /**
     * \brief Sets the session manager and fl-sim provider
     * \param pSessionManager Session Manager for this experiment
     * \param fl_sim_provider Fl-sim provider for this experiment
     */
    // TODO: move to cc file
    void SetClientSessionManager(ClientSessionManager* pSessionManager,
  ...
  private:
    ...
    std::map<Ptr<Socket>, std::shared_ptr<ClientSessionData>>
